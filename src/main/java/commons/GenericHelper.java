...
public class GenericHelper {
    ...
    public void progressBar(WebElement webElement) {

    	TouchAction touchAction = new TouchAction((AppiumDriver) driver);
    	touchAction.longPress(ElementOption.element(webElement)).moveTo(ElementOption.element(webElement, 250, 250))
    					.release().perform();
	}
    public void moveTo(WebElement source, WebElement destination) {
    	TouchAction touchAction = new TouchAction((AppiumDriver) driver);
